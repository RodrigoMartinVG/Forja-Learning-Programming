...
El paso 5 importa porque el script resume, pero no reemplaza, tu modelo mental.
...
Si una herramienta que esperabas no aparece ahi, eso no significa que este prohibida. Significa que todavia no forma parte del contrato base y tal vez deba agregarse en `devcontainer-setup`.
...
La primera salida te muestra el estado observado. La segunda te muestra el contrato que produce ese estado.
